...
* Depending on which private sharing mode you run, you may need a valid Digi.me client application on your phone/desktop, with a library created on it ([See below for more info](#setting-up-the-digi.me-library))
